...
import samplePlug.HalsteadVocabularyCheck;
...
public class HalsteadVocabularyWhiteTest {
    ...
    HalsteadVocabularyCheck halCheck;
    ...
    public void setUp() {
    	...
    	// mocking halchecker
        halCheck = spy(new HalsteadVocabularyCheck());
