...
import samplePlug.HalsteadDifficultyCheck;
...
public class HalsteadDifficultyWhiteTest {
    ...
    HalsteadDifficultyCheck halCheck;
    ...
    public void setUp() {
    	...
    	// mocking halchecker
        halCheck = spy(new HalsteadDifficultyCheck());
